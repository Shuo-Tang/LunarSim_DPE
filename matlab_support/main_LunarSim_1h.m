...
estPos2SP_1h = estPos2SP;
errPos2SP_1h = errPos2SP;
estPosDPE_1h = estPosDPE;
errPosDPE_1h = errPosDPE;
save('estPos2SP_1h.mat','estPos2SP_1h');
save('errPos2SP_1h.mat','errPos2SP_1h')
save('estPosDPE_1h.mat','estPosDPE_1h');
save('errPosDPE_1h.mat','errPosDPE_1h')
close(h);
fprintf('Done. \n');
